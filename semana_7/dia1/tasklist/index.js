...
function saveTask(element) {
    ...
    <div class='col-6 col-sm-4 col-md-3'>
      <button class='btn btn-light ${task.status=== "done" ? "d-none" :""}' onclick="editTask(this)">✏️</button>
      <button class='btn btn-light'>👁</button>
      <button class='btn btn-dark ${task.status=== "done" ? "d-none" :""}' onclick="deleteTask(this)">❌</button>
    </div>
  `);
}
...
function createInputTask(id, text, status) {
  $(
    ...
    .html(
      ...
      <div class='col-6 col-sm-4 col-md-3'>
        <button class='btn btn-light ${status=== "done" ? "d-none" :""}' onclick="editTask(this)">✏️</button>
        <button class='btn btn-light' onclick="showTask(${id})">👁</button>
        <button class='btn btn-dark ${status=== "done" ? "d-none" :""}' onclick="deleteTask(this)">❌</button>
      </div>
    `
    )
