...
// Utilizando un for, crear 10 carros todos del mismo color,
// pero cada carro con velocidades diferentes 
// imprimir todos los carros en el contenedor

// div_container.innerHTML += "<hr>";
// div_container.innerHTML += "<h2>Crear carros</h2>";

// let carros = Number(prompt("Ingrese numero de carros"));

// function carrosPoderosos(){
//     let a = "rojo";

//     let resultado = " ";
//     for(let i = 0 ; i <= carros ; i++){
//         let min =(i+10)*5;
//         let nCarros = new Carro(a, Math.round(Math.random() * (360 - min + 1) + min));
        
//         resultado = div_container.innerHTML += "<p>"+ nCarros.presentacion()+"</p>";
//     }
//     return resultado;
